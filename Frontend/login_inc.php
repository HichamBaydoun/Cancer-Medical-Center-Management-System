	...
	<div id="apDiv1">
		...
		<div id="apDiv6">
			<table width="1071" height="54" border="0">
				<tr>
					<td width="186">
						<div align="center" id="ap6"><a href="index.html">Home</a></div>
					</td>
					<td width="260">
						<div align="center"><a href="patient.php">Patient & Visitor's</a></div>
					</td>
					<td width="203">
						<div align="center"><a href="doctor.php">Doctors</a></div>
					</td>
					<td width="233">
						<div align="center"><a href="feedback.php">Feedback</a></div>
					</td>
					<td width="167">
							...
							<form name="form1" method="post" action="p_logincheck.php">
								<table width="270" border="0">
									...
									<tr>
										<td height="47" colspan="3">
											<div align="center"><i>
													<font color="#CC0000">Login Incorrect</font>
												</i></div>
										</td>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
		...
		<div id="apDiv10">
			<div align="left">
				<p style="font-size:36px; height: 20px; color: #030;">Patient and Visitors</p>
				<hr size="2px">
