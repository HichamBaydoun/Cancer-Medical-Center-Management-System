...
<body vlink="#FFFFFF">
	<div id="apDiv1">
		...
		<div id="apDiv17">
			<table width="1000" height="39" border="0" cellpadding="1" cellspacing="1" id="myTable">
				...
				<tr>
					...
					$uid = $_SESSION['id'];
					$querySelect1 = "select patient_history.patientID ,p_name, patient_history.doctorID,d_name, details, date, time, historyID from patient_history, doctor, patient where patient_history.doctorID='$uid' and patient.patientID = patient_history.patientID and doctor.doctorID = patient_history.doctorID";
					...
					while ($row1 = mysqli_fetch_row($result1)) {
						...
						print "<a href='his_update1.php?hid=" . $row1[7] . "'>Edit</a>";
						print "</td>";
						print "<td align='center' class='delete'>";
						print "<a href='his_delete.php?hid=" . $row1[7] . "'>Delete</a>";
						print "</td>";
						print "</tr>";
					}
					?>
