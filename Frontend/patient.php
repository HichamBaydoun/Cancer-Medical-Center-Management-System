...
<body vlink="#FFFFFF">
	<div id="apDiv1">
		...
		<div id="apDiv7">
			<div align="left">
				<p style="font-size:36px; height: 20px; color: #2e3196;">Patients</p>
				<hr color="#2e3196" size="4px">
				<p style="font-size:18px; font-family:'Times New Roman', Times, serif; font-weight:600;color: black">
					Thank you for choosing Daisy Cancer Medical Center for your healthcare needs. We are committed on treating all patients
					with compassion and providing personalized health care
					services in a friendly, caring and costeffective manner while continuously
					improving quality, safety, comfort and
					well-being. We hope you have a fast recovery with an easy experience in our system.
				</p>
		...
		<div id="apDiv8">
			<table width="273" height="36" border="0">
				<tr>
					<td>
						<div align="center">Patient Login</div>
						<hr>
					</td>
				</tr>
				<tr>
					<td>
						<div class="AccordionPanelContent">
							<form id="form1" name="form1" method="post" action="p_logincheck.php">
									...
									<tr>
										<td height="42" colspan="3">
											<div align="center"><a href="signup.php">
													<font color="red" style="font-size:16px;"><i><u>Don't have an account? Signup here.</u></i></font>
												</a></div>
										</td>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
