...
<head>
	...
	<div id="apDiv12">
		<div id="apDiv15">
			...
			$uid = $_SESSION['id'];
			$querySelect = "select d_image from doctor where doctorID='$uid'";
		...
		<div id="apDiv8">
			<table width="191" height="235" border="0">
				<tr>
					<td width="195">
						<div align="center"><a href="doctor_profile.php">Profile</a></div>
					</td>
				</tr>
				<tr>
					<td onMouseOver="show1()" onMouseOut="hide1()">
						<div align="center"><a href="#">Patient History</a></div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<div align="center"><a href="p_report.php">Upload Report</a></div>
					</td>
				</tr>
				<tr>
					<td class="logout">
						<div align="center"><a href="d_logout.php">Logout</a></div>
					</td>
				</tr>
			</table>
		</div>
		<div id="apDiv11" onMouseOver="show()" onMouseOut="hide()">
			<table width="250" height="80" border="0">
				<tr>
					<td>
						<div align="center"><a href="d_view_app.php">View Appointment</a></div>
					</td>
				</tr>
				<tr>
					<td>
						<div align="center"><a href="d_cancel_app.php">Cancel Appointment</a></div>
					</td>
				</tr>
			</table>
		</div>
	...
	<div id="apDiv16" onMouseOver="show1()" onMouseOut="hide1()">
		<table width="169" height="110" border="0">
			<tr>
				<td>
					<div align="center"><a href="his_view.php">View</a></div>
				</td>
			</tr>
			<tr>
				<td>
					<div align="center"><a href="his_update.php">Update</a></div>
				</td>
			</tr>
			<tr>
				<td>
					<div align="center"><a href="his_upload.php">Upload</a></div>
				</td>
			</tr>
		</table>
	</div>